 ...
 * Taller Spring - 2
 * 
 * Implementacion de Pedido (península)
 * 
 * @author Rafael José
 *
 */
...
@Primary
public class OrderPeninsulaManagementImpl implements OrderManagementI {
	...
	public double breakdownOrder(Order order) {
		...
		for (Product product : products) {
			...
			double erpPrice = productPrice + (productPrice * 21 / 100);
